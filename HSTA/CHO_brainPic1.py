...
for num in range(5, 6):
    ...
    class MyModel(nn.Module):
        def __init__(self):
            ...
            self.mlp5 = MLP(1230, 615, 64, 1)

            self.mlp = MLP(6720, 3360, 64, 1)
    ...
    test_dataloader_partition = DataLoader(test_dataset, batch_size=batch_size, drop_last=True, shuffle=True)
    ...
    # 保存模型
    folder_path = "D:\pythonProject\svr/brainPic"
    file_name = "CHO_subject_{}_best_model.pth".format(num)
