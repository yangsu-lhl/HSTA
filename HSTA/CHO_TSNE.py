...
#         # plt.figure(figsize=(8, 6))
#         # # plt.scatter(X_embedded[:, 0], X_embedded[:, 1])
#         # plt.scatter(X_embedded[labels == 0, 0], X_embedded[labels == 0, 1], c='r', marker='o', label='left hand')
#         # plt.scatter(X_embedded[labels == 1, 0], X_embedded[labels == 1, 1], c='b', marker='^', label='right hand')
#         # plt.scatter(X_embedded[labels == 2, 0], X_embedded[labels == 2, 1], c='g', marker='x', label='both hand')
#         # plt.scatter(X_embedded[labels == 3, 0], X_embedded[labels == 3, 1], c='y', marker='*', label='both foot')
...
#
#     # 保存模型
#     folder_path = "D:\pythonProject\svr/CHO_model_TSNE"
#     file_name = "TSNE_model.pth".format(num)
...
# # 保存DataFrame为Excel文件
# # file_path = "CHO_cross_test_best_accuracy.xlsx"  # 文件路径和名称
